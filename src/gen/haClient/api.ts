 ...
 *
 * @export
 * @interface VersionTranscript
 */
export interface VersionTranscript {
  /**
   *
   * @type {string}
   * @memberof VersionTranscript
   */
  id?: string
  /**
   *
...
export const TranscriptsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    /**
     *
     * @summary Create a claim for a specific transcript
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {string} vId Version identifier
     * @param {string} cId Claim identifier
     * @param {Array<Claim>} claim Groups to update
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    createTranscriptClaim: async (
      studentId: string,
      tId: string,
      vId: string,
      cId: string,
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('createTranscriptClaim', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('createTranscriptClaim', 'tId', tId)
      // verify required parameter 'vId' is not null or undefined
      assertParamExists('createTranscriptClaim', 'vId', vId)
      // verify required parameter 'cId' is not null or undefined
      assertParamExists('createTranscriptClaim', 'cId', cId)
      // verify required parameter 'claim' is not null or undefined
      assertParamExists('createTranscriptClaim', 'claim', claim)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions/{vId}/claims/{cId}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
      ...
      let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {}
      localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers }
      localVarRequestOptions.data = serializeDataIfNeeded(claim, localVarRequestOptions, configuration)
    ...
    /**
     *
     * @summary Get a specific transcript of a student in a specific version in a PDF format.
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {string} vId Version identifier
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getPDFStudentTranscriptVersion: async (studentId: string, tId: string, vId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getPDFStudentTranscriptVersion', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('getPDFStudentTranscriptVersion', 'tId', tId)
      // verify required parameter 'vId' is not null or undefined
      assertParamExists('getPDFStudentTranscriptVersion', 'vId', vId)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions/{vId}/raw`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
        .replace(`{${'vId'}}`, encodeURIComponent(String(vId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     *
     * @summary Get the last version of a specific transcript of a student.
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptBytId: async (studentId: string, tId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptBytId', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('getStudentTranscriptBytId', 'tId', tId)
      const localVarPath = `/students/{student_id}/transcripts/{tId}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
    ...
    /**
     *
     * @summary Get the required claim of a specific transcript.
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {string} vId Version identifier
     * @param {string} cId Claim identifier
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptClaim: async (studentId: string, tId: string, vId: string, cId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptClaim', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('getStudentTranscriptClaim', 'tId', tId)
      // verify required parameter 'vId' is not null or undefined
      assertParamExists('getStudentTranscriptClaim', 'vId', vId)
      // verify required parameter 'cId' is not null or undefined
      assertParamExists('getStudentTranscriptClaim', 'cId', cId)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions/{vId}/claims/{cId}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
        .replace(`{${'vId'}}`, encodeURIComponent(String(vId)))
    ...
    /**
     *
     * @summary Get all claims of a specific transcript.
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {string} vId Version identifier
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptClaims: async (studentId: string, tId: string, vId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptClaims', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('getStudentTranscriptClaims', 'tId', tId)
      // verify required parameter 'vId' is not null or undefined
      assertParamExists('getStudentTranscriptClaims', 'vId', vId)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions/{vId}/claims`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
        .replace(`{${'vId'}}`, encodeURIComponent(String(vId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     *
     * @summary Get a specific transcript of a student in a specific version.
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {string} vId Version identifier
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptVersionByvId: async (studentId: string, tId: string, vId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptVersionByvId', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('getStudentTranscriptVersionByvId', 'tId', tId)
      // verify required parameter 'vId' is not null or undefined
      assertParamExists('getStudentTranscriptVersionByvId', 'vId', vId)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions/{vId}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
        .replace(`{${'vId'}}`, encodeURIComponent(String(vId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     *
     * @summary Get all versions of a specific transcript of a student.
     * @param {string} studentId Student identifier
     * @param {string} tId Transcript identifier
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptVersions: async (studentId: string, tId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptVersions', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('getStudentTranscriptVersions', 'tId', tId)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
    ...
    /**
     *
     * @summary Get all transcripts of a student.
     * @param {string} studentId
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscripts: async (studentId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
    ...
    /**
     *
     * @summary post PDF file of latest transcript version
     * @param {string} studentId student identifier
     * @param {string} tId transcript identifier
     * @param {File} body
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    postTranscriptPdfVersion: async (studentId: string, tId: string, body: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('postTranscriptPdfVersion', 'studentId', studentId)
      // verify required parameter 'tId' is not null or undefined
      assertParamExists('postTranscriptPdfVersion', 'tId', tId)
      // verify required parameter 'body' is not null or undefined
      assertParamExists('postTranscriptPdfVersion', 'body', body)
      const localVarPath = `/students/{student_id}/transcripts/{tId}/versions/latest/raw`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'tId'}}`, encodeURIComponent(String(tId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
...
export const TranscriptsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator = TranscriptsApiAxiosParamCreator(configuration)
  return {
    /**
     *
     * @summary Create a claim for a specific transcript
    ...
    async createTranscriptClaim(
      ...
      claim: Array<Claim>,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Claim>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createTranscriptClaim(studentId, tId, vId, cId, claim, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getPDFStudentTranscriptVersion(
      studentId: string,
      tId: string,
      vId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPDFStudentTranscriptVersion(studentId, tId, vId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptBytId(
      studentId: string,
      tId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Transcript>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptBytId(studentId, tId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptClaim(
      studentId: string,
      tId: string,
      vId: string,
      cId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Claim>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptClaim(studentId, tId, vId, cId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
    ...
    async getStudentTranscriptClaims(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptClaims(studentId, tId, vId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptVersionByvId(
      studentId: string,
      tId: string,
      vId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Version>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptVersionByvId(studentId, tId, vId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptVersions(
      studentId: string,
      tId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Version>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptVersions(studentId, tId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
    ...
    async getStudentTranscripts(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscripts(studentId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async postTranscriptPdfVersion(
      studentId: string,
      tId: string,
      body: File,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Version>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postTranscriptPdfVersion(studentId, tId, body, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    }
  }
}
...
export const TranscriptsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  const localVarFp = TranscriptsApiFp(configuration)
  return {
    /**
     *
     * @summary Create a claim for a specific transcript
     ...
     * @throws {RequiredError}
     */
    createTranscriptClaim(studentId: string, tId: string, vId: string, cId: string, claim: Array<Claim>, options?: any): AxiosPromise<Array<Claim>> {
      return localVarFp.createTranscriptClaim(studentId, tId, vId, cId, claim, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get a specific transcript of a student in a specific version in a PDF format.
     ...
     * @throws {RequiredError}
     */
    getPDFStudentTranscriptVersion(studentId: string, tId: string, vId: string, options?: any): AxiosPromise<File> {
      return localVarFp.getPDFStudentTranscriptVersion(studentId, tId, vId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get the last version of a specific transcript of a student.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptBytId(studentId: string, tId: string, options?: any): AxiosPromise<Transcript> {
      return localVarFp.getStudentTranscriptBytId(studentId, tId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get the required claim of a specific transcript.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptClaim(studentId: string, tId: string, vId: string, cId: string, options?: any): AxiosPromise<Claim> {
      return localVarFp.getStudentTranscriptClaim(studentId, tId, vId, cId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get all claims of a specific transcript.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptClaims(studentId: string, tId: string, vId: string, options?: any): AxiosPromise<Array<Claim>> {
      return localVarFp.getStudentTranscriptClaims(studentId, tId, vId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get a specific transcript of a student in a specific version.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptVersionByvId(studentId: string, tId: string, vId: string, options?: any): AxiosPromise<Version> {
      return localVarFp.getStudentTranscriptVersionByvId(studentId, tId, vId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get all versions of a specific transcript of a student.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptVersions(studentId: string, tId: string, options?: any): AxiosPromise<Array<Version>> {
      return localVarFp.getStudentTranscriptVersions(studentId, tId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get all transcripts of a student.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscripts(studentId: string, options?: any): AxiosPromise<Array<Transcript>> {
      return localVarFp.getStudentTranscripts(studentId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary post PDF file of latest transcript version
     ...
     * @throws {RequiredError}
     */
    postTranscriptPdfVersion(studentId: string, tId: string, body: File, options?: any): AxiosPromise<Version> {
      return localVarFp.postTranscriptPdfVersion(studentId, tId, body, options).then(request => request(axios, basePath))
    }
  }
}
...
export class TranscriptsApi extends BaseAPI {
   ...
   */
  public createTranscriptClaim(studentId: string, tId: string, vId: string, cId: string, claim: Array<Claim>, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .createTranscriptClaim(studentId, tId, vId, cId, claim, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getPDFStudentTranscriptVersion(studentId: string, tId: string, vId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getPDFStudentTranscriptVersion(studentId, tId, vId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getStudentTranscriptBytId(studentId: string, tId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getStudentTranscriptBytId(studentId, tId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getStudentTranscriptClaim(studentId: string, tId: string, vId: string, cId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getStudentTranscriptClaim(studentId, tId, vId, cId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getStudentTranscriptClaims(studentId: string, tId: string, vId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getStudentTranscriptClaims(studentId, tId, vId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getStudentTranscriptVersionByvId(studentId: string, tId: string, vId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getStudentTranscriptVersionByvId(studentId, tId, vId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getStudentTranscriptVersions(studentId: string, tId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getStudentTranscriptVersions(studentId, tId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public getStudentTranscripts(studentId: string, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .getStudentTranscripts(studentId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptsApi
   */
  public postTranscriptPdfVersion(studentId: string, tId: string, body: File, options?: AxiosRequestConfig) {
    return TranscriptsApiFp(this.configuration)
      .postTranscriptPdfVersion(studentId, tId, body, options)
      .then(request => request(this.axios, this.basePath))
  }
}
